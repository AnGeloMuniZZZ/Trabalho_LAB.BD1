			...
			<form action="visualizarExemplar" method="post">
				...
				<table>
					<tr>
						...
						<td colspan="1"><input type="number" min="0" step="1"
							name="cod" id="cod" placeholder="Código"
					...
					<tr>
						<td colspan="1"><label for="qtd_paginas">Qtd.
								paginas:</label></td>
						<td colspan="2"><p>
								<c:out value="${livro.qtd_paginas }" />
							</p></td>
					</tr>
					<tr>
						<td colspan="1"><label for="sigla">Sigla:</label></td>
						<td colspan="2"><p>
								<c:out value="${livro.sigla }" />
							</p></td>
					</tr>
					<tr>
						...
						<tbody>
							<c:forEach var="l" items="${livros }">
								<tr>
									...
									<td><a class="a_link_clicavel"
										href="${pageContext.request.contextPath }/visualizarExemplar?acao=editar&id=${l.codigo_exemplar}">VER</a></td>
								</tr>
							</c:forEach>
							<c:forEach var="r" items="${revistas }">
								<tr>
									...
									<td></td>
									<td><a class="a_link_clicavel"
										href="${pageContext.request.contextPath }/visualizarExemplar?acao=editar&id=${r.codigo_exemplar}">VER</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
