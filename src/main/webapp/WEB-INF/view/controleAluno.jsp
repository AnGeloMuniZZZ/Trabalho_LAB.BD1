...
<body>
	...
	<div align="center" class="div_degrade">
			...
			<form action="controleAluno" method="post">
				...
				<table>
					<tr>
						...
						<td colspan="3"><input type="number" name="cpf" id="cpf" placeholder="CPF" value='<c:out value="${aluno.cpf }"/>'></td>
						<td colspan="1"><input type="submit" name="botao" value="Buscar"></td>
					</tr>
					<tr>
						<td colspan="1" class="td_alinhar_justo"><p>RA:</p></td>
						<td colspan="5"><p><c:out value="${aluno.ra }" /></p></td>
					</tr>
					<tr>
						<td colspan="1"><p>Nome:</p></td>
						<td colspan="5"><p><c:out value="${aluno.nome_completo }" /></p></td>
					</tr>
					<tr>
						<td colspan="1"><p>Email:</p></td>
						<td colspan="5"><p><c:out value="${aluno.email }" /></p></td>
					</tr>
					<tr>
						<td colspan="1"><p>Senha:</p></td>
						<td colspan="5"><input type="text" name="senha" id="senha" placeholder="Senha" value='<c:out value="${aluno.senha }"/>'></td>
					</tr>
					<tr>
						<td colspan="2"><input style="width: 100%" type="submit" name="botao" value="Atualizar"></td>
		...
		<div>
			<br/>
			<a class="a_link_clicavel" href="loginAdministrador">Deslogar</a> <a class="a_link_clicavel" href="controleExemplar">Cadastrar Exemplares</a>
		</div>
					...
					<tbody>
						<c:forEach var="a" items="${alunos }">
							<tr>
								...
								<td>${a.email }</td>
								<td>${a.senha }</td>
								<td><a class="a_link_clicavel" href="${pageContext.request.contextPath }/controleAluno?acao=editar&id=${a.cpf}">EDITAR</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
